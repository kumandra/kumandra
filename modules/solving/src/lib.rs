...
//! [Kumandra Network Blockchain](https://kumandra.org).
...
pub use codec::{BatchEncodeError, KumandraCodec};
...
const LOCAL_CHALLENGE_LABEL: &[u8] = b"kumandra_local_challenge";
const PLOT_TARGET_CONTEXT: &[u8] = b"kumandra_plot_target";
const TAG_SIGNATURE_LABEL: &[u8] = b"kumandra_tag_signature";

/// Signing context used for creating reward signatures by farmers.
pub const REWARD_SIGNING_CONTEXT: &[u8] = b"kumandra_reward";
