...
//! Codec for the [Kumandra Network Blockchain](https://github.com/kumandra/kumandra/) based on the
...
use kumandra_core_primitives::{crypto, PieceIndex, Sha256Hash, PIECE_SIZE};
...
/// Kumandra codec is used to encode pieces of archived history before writing them to disk and also
/// to decode them after reading from disk.
#[derive(Debug, Clone)]
pub struct KumandraCodec {
