...
use crate::{ArchivedSegmentNotification, KumandraLink, KumandraNotificationSender};
use codec::Encode;
        ...
        for extrinsic in block.block.extrinsics() {
                ...
                .extract_root_blocks(&block_to_check, extrinsic)
            {
                ...
                Err(error) => {
                    ...
                    error!(target: "kumandra", "Failed to make runtime API call: {:?}", error);
                }
            }
        }
...
pub fn start_kumandra_archiver<Block: BlockT, Client>(
        ...
        Box::pin({
            ...
            async move {
                    ...
                    imported_block_notification_stream.next().await
                {
                    ...
                    debug!(target: "kumandra", "Archiving block {:?}", block_to_archive);
