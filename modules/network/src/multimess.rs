...
/// Start of Kumandra Protocol multicodec namespace (+1000 to distinguish from future stable values):
/// https://github.com/multiformats/multicodec/blob/master/table.csv
const KUMANDRA_MULTICODEC_NAMESPACE_START: u64 = 0xb49910 + 1000;

#[repr(u64)]
pub enum MultihashCode {
    PieceIndex = KUMANDRA_MULTICODEC_NAMESPACE_START + 1,
    Piece = KUMANDRA_MULTICODEC_NAMESPACE_START,
}
