...
use sp_core::H256;
use kp_executor::{ExecutionPhase, ExecutorApi, FraudProof, VerificationError};
...
pub trait VerifyFraudProof {
    ...
    fn verify_fraud_proof(&self, proof: &kp_executor::FraudProof) -> Result<(), VerificationError>;
}
