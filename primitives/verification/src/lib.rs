...
use kumandra_solving::{
    ...
    verify_local_challenge, verify_tag_signature, KumandraCodec,
};

const SALT_HASHING_PREFIX_LEN: usize = SALT_HASHING_PREFIX.len();

/// Errors encountered by the Kumandra consensus primitives.
    ...
    &'a FarmerPublicKey: Into<PublicKey>,
{
    ...
    let kumandra_codec = KumandraCodec::new(public_key.as_ref());
    kumandra_codec
