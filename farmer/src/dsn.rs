...
use kumandra_networking::libp2p::core::multihash::{Code, MultihashDigest};
use kumandra_networking::{PiecesByRangeRequest, PiecesByRangeResponse, PiecesToPlot};
...
pub enum GetPiecesByRangeError {
    ...
    CannotGetClosestPeers(#[source] kumandra_networking::GetClosestPeersError),
    /// Node runner was dropped, impossible to get pieces by range.
    #[error("Node runner was dropped, impossible to get pieces by range")]
    NodeRunnerDropped(#[source] kumandra_networking::SendRequestError),
}
