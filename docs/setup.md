...
This page will guide you through the **2 steps** needed to prepare a computer for **Kumandra** development.
...
Kumandra development is easiest on Unix-based operating systems like macOS or Linux.
