...
# Path to the kumandra-node binary (important use short-session feature):
binary = abspath(os.getenv('KUMANDRA_NODE_BINARY', join(workdir, 'kumandra-node')))
...
chain.start('kumandra', nodes=[3, 4])
