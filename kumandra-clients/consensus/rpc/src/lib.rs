...
use kumandra_core_primitives::{BlockNumber, Solution};
...
pub trait KumandraRpcApi {
    ...
    #[pubsub(
        subscription = "kumandra_slot_info",
        unsubscribe,
        name = "kumandra_unsubscribeSlotInfo"
    )]
    ...
    #[pubsub(
        subscription = "kumandra_block_signing",
        subscribe,
        name = "kumandra_subscribeBlockSigning"
    )]
    ...
    #[pubsub(
        subscription = "kumandra_block_signing",
        unsubscribe,
        name = "kumandra_unsubscribeBlockSigning"
    )]
    ...
    #[rpc(name = "kumandra_submitBlockSignature")]
    fn submit_block_signature(&self, block_signature: BlockSignature) -> FutureResult<()>;

    /// Archived segment subscription
    #[pubsub(
        subscription = "kumandra_archived_segment",
        subscribe,
        name = "kumandra_subscribeArchivedSegment"
    )]
    ...
    #[pubsub(
        subscription = "kumandra_archived_segment",
        unsubscribe,
        name = "kumandra_unsubscribeArchivedSegment"
    )]
    ...
    #[rpc(name = "kumandra_acknowledgeArchivedSegment")]
...
/// Implements the [`KumandraRpcApi`] trait for interacting with Kumandra.
pub struct KumandraRpcHandler<Block, Client> {
    client: Arc<Client>,
...
/// [`KumandraRpcHandler`] is used for notifying subscribers about arrival of new slots and for
            ...
            let farmer_metadata: Result<FarmerMetadata, ApiError> = try {
                FarmerMetadata {
                    ...
                    max_plot_size: runtime_api
                        ...
                        //  to newer
                        .unwrap_or(
                            100 * 1024 * 1024 * 1024 / kumandra_core_primitives::PIECE_SIZE as u64,
                        ),
                }
            };
