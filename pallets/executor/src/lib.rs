        ...
        fn validate_unsigned(_source: TransactionSource, call: &Self::Call) -> TransactionValidity {
            match call {
                Call::submit_execution_receipt {
                    ...
                    let builder =
                        ValidTransaction::with_tag_prefix("KumandraSubmitExecutionReceipt")
                            .priority(TransactionPriority::MAX)
                ...
                Call::submit_transaction_bundle {
                    ...
                    unsigned_validity(
                        "KumandraSubmitTransactionBundle",
    ...
    T: Config + frame_system::offchain::SendTransactionTypes<Call<T>>,
{
    ...
    pub fn submit_fraud_proof_unsigned(fraud_proof: FraudProof) {
        ...
        match SubmitTransaction::<T, Call<T>>::submit_unsigned_transaction(call.into()) {
            Ok(()) => {
                log::info!(target: "runtime::kumandra::executor", "Submitted fraud proof");
            }
            Err(()) => {
                log::error!(target: "runtime::kumandra::executor", "Error submitting fraud proof");
            }
        }
    }
