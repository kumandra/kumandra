        ...
        fn validate_unsigned(_source: TransactionSource, call: &Self::Call) -> TransactionValidity {
            match call {
                ...
                Call::submit_transaction_bundle { opaque_bundle } => {
                    ...
                    unsigned_validity("KumandraSubmitTransactionBundle", opaque_bundle.hash())
                }
                ...
                Call::submit_bundle_equivocation_proof {
                    ...
                    unsigned_validity(
                        "KumandraSubmitBundleEquivocationProof",
                ...
                Call::submit_invalid_transaction_proof {
                    ...
                    unsigned_validity(
                        "KumandraSubmitInvalidTransactionProof",
                        invalid_transaction_proof,
                    )
                }
    ...
    T: Config + frame_system::offchain::SendTransactionTypes<Call<T>>,
{
    ...
    pub fn submit_execution_receipt_unsigned(
        ...
        match SubmitTransaction::<T, Call<T>>::submit_unsigned_transaction(call.into()) {
            Ok(()) => {
                log::info!(target: "runtime::kumandra::executor", "Submitted execution receipt.")
            }
            Err(e) => log::error!(
                target: "runtime::kumandra::executor",
    ...
    pub fn submit_transaction_bundle_unsigned(
        ...
        match SubmitTransaction::<T, Call<T>>::submit_unsigned_transaction(call.into()) {
            Ok(()) => {
                log::info!(target: "runtime::kumandra::executor", "Submitted transaction bundle.")
            }
            Err(e) => log::error!(
                target: "runtime::kumandra::executor",
    ...
    pub fn submit_fraud_proof_unsigned(
        ...
        match SubmitTransaction::<T, Call<T>>::submit_unsigned_transaction(call.into()) {
            Ok(()) => log::info!(target: "runtime::kumandra::executor", "Submitted fraud proof."),
            Err(e) => {
                log::error!(target: "runtime::kumandra::executor", "Error submitting fraud proof: {:?}", e,)
            }
        }
    ...
    pub fn submit_bundle_equivocation_proof_unsigned(
        ...
        match SubmitTransaction::<T, Call<T>>::submit_unsigned_transaction(call.into()) {
            Ok(()) => {
                log::info!(target: "runtime::kumandra::executor", "Submitted bundle equivocation proof.")
            }
            Err(e) => log::error!(
                target: "runtime::kumandra::executor",
    ...
    pub fn submit_invalid_transaction_proof_unsigned(
        ...
        match SubmitTransaction::<T, Call<T>>::submit_unsigned_transaction(call.into()) {
            Ok(()) => {
                log::info!(target: "runtime::kumandra::executor", "Submitted invalid transaction proof.")
            }
            Err(e) => log::error!(
                target: "runtime::kumandra::executor",
