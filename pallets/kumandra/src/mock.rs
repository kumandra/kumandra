...
use kp_consensus::{FarmerSignature, SignedVote, Vote};
...
use kumandra_solving::{
    ...
    KumandraCodec, REWARD_SIGNING_CONTEXT,
};
...
pub fn new_test_ext() -> sp_io::TestExternalities {
    ...
    GenesisBuild::<Test>::assimilate_storage(&pallet_kumandra::GenesisConfig::default(), &mut t)
        .unwrap();
...
pub fn generate_equivocation_proof(
    ...
    let seal_header = |header: &mut Header| {
        ...
        let seal = DigestItem::kumandra_seal(signature);
...
pub fn extract_piece(
    ...
    let codec = KumandraCodec::new(keypair.public.as_ref());
