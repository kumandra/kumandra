...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        Kumandra: pallet_kumandra::{Pallet, Storage},
...
impl_opaque_keys! {
    pub struct TestSessionKeys {
        pub kumandra: super::Pallet<Test>,
    }
}
...
pub fn new_test_ext(authorities: &[(u64, u64)]) -> sp_io::TestExternalities {
    ...
    let session_keys: Vec<_> = authorities
        ...
        .enumerate()
        .map(|(i, (k, _))| (i as u64, i as u64, TestSessionKeys { kumandra: k }))
        .collect();
...
pub(crate) fn run_session(n: u32) {
    for i in Session::current_index()..n {
        ...
        Kumandra::on_initialize(System::block_number());
    }
}
