...
use crate::mock::{
    ...
    Event, Origin, ReportLongevity, Kumandra, System, Test, INITIAL_SOLUTION_RANGE,
    SLOT_PROBABILITY,
};
...
use kp_consensus::{FarmerPublicKey, GlobalRandomnesses, Salts, SolutionRanges};
...
fn can_update_solution_range_on_era_change() {
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(Kumandra::enable_solution_range_adjustment(Origin::root()));
