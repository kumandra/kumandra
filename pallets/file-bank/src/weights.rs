...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("kumandra-hacknet"), DB CACHE: 128

// Executed Command:

// D:\workspace\substrate\internal-kumandra-node\target\release\kumandra-node.exe
...
// --output=./kumandra-pallets/file-bank/src/weights.rs
