...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("kumandra-staking-testnet"), DB CACHE: 1024

// Executed Command:
// ./target/release/kumandra-node
// benchmark
// --chain
// kumandra-staking-testnet
// --execution=wasm
...
// --output=./pallets/segment-book/src/weights_demo.rs
