...
use pallet_kumandra_staking::{StashOf, Exposure, ExposureOf, BalanceOf};
...
use kp_scheduler_credit::SchedulerStashAccountFinder;
...
frame_support::construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Staking: pallet_kumandra_staking::{Pallet, Call, Config<T>, Storage, Event<T>},
...
impl pallet_kumandra_staking::Config for Test {
    ...
    type BenchmarkingConfig = pallet_kumandra_staking::TestBenchmarkingConfig;
    type WeightInfo = ();
}
