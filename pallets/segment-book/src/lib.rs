//! # Segemnt Book Module
//!
//!  This file is the exclusive pallet of kumandra and the proof of podr2 adaptation
//!
//! ## OverView
//!
...
use kp_common::DataType;
pub mod weights;
pub use weights::WeightInfo;
use kp_common::Hash as H68;

type AccountOf<T> = <T as frame_system::Config>::AccountId;
type BlockNumberOf<T> = <T as frame_system::Config>::BlockNumber;
type Hash = H68;
pub const SEGMENT_BOOK: KeyTypeId = KeyTypeId(*b"kuma");
