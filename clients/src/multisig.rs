...
impl MultisigParty {
    ...
    pub fn initiate_aggregation_with_hash<C: AnyConnection>(
        ...
        info!(target: "kumandra-client", "Initiating multisig aggregation for call hash: {:?}", call_hash);
    ...
    pub fn approve<C: AnyConnection>(
        ...
        info!(target: "kumandra-client", "Registered multisig approval for call hash: {:?}", sig_agg.call_hash);
        sig_agg
            .approvers
    ...
    pub fn cancel<C: AnyConnection>(
        ...
        info!(target: "kumandra-client", "Cancelled multisig aggregation for call hash: {:?}", sig_agg.call_hash);
        Ok(())
    }
}
