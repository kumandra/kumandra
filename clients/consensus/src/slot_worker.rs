...
use crate::{NewSlotInfo, NewSlotNotification, RewardSigningNotification, KumandraLink};
...
use kp_consensus::digests::{extract_pre_digest, CompatibleDigestItem, PreDigest};
    ...
    async fn sign_reward(
        ...
        while let Some(signature) = signature_receiver.next().await {
            if check_reward_signature(
                ...
                &kumandra_core_primitives::PublicKey::from(public_key),
