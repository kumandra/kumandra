...
use kmc_consensus_rrsc::{Config, Epoch};
use kmc_consensus_rrsc_rpc::RRSCRpcHandler;
...
use kmp_consensus_rrsc::RRSCApi;
	...
	A: ChainApi<Block = Block> + 'static,
{
	...
	io.extend_with(kmc_consensus_rrsc_rpc::RRSCApi::to_delegate(RRSCRpcHandler::new(
		client.clone(),
	...
	io.extend_with(kmc_sync_state_rpc::SyncStateRpcApi::to_delegate(
		kmc_sync_state_rpc::SyncStateRpcHandler::new(
			chain_spec,
			client.clone(),
			shared_authority_set,
	...
	io.extend_with(EthApiServer::to_delegate(EthApi::new(
		...
		pool.clone(),
		graph,
		Some(kumandra_node_runtime::TransactionConverter),
		network.clone(),
		signers,
		overrides.clone(),
