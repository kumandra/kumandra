...
pub fn parachain_build_import_queue(
	...
	sc_service::Error,
> {
	let slot_duration = forests_client_consensus_aura::slot_duration(&*client)?;

	forests_client_consensus_aura::import_queue::<
		...
		_,
		_,
	>(forests_client_consensus_aura::ImportQueueParams {
