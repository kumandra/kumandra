    ...
    match &cli.subcommand {
        ...
        Some(Subcommand::PurgeChain(cmd)) => {
            ...
            if cmd.base.shared_params.base_path().is_none() {
                let old_dirs = &[
                    "kumandra-node-x86_64-macos-11-snapshot-2022-jan-05",
                    "kumandra-node-x86_64-ubuntu-20.04-snapshot-2022-jan-05",
                    "kumandra-node-x86_64-windows-2019-snapshot-2022-jan-05.exe",
                    "kumandra-node-x86_64-windows-2022-snapshot-2022-jan-05.exe",
                    "kumandra-node-macos-x86_64-snapshot-2022-mar-09",
                    "kumandra-node-ubuntu-x86_64-snapshot-2022-mar-09",
                    "kumandra-node-windows-x86_64-snapshot-2022-mar-09.exe",
                ];
