...
use neak_node_primitives::PersistedValidationData;
...
const LOG_TARGET: &str = "neak::consensus::relay-chain";
	...
	CIDP: CreateInherentDataProviders<B, (PHash, PersistedValidationData)>,
{
	...
	pub fn new(
		...
		block_import: BI,
		selendra_client: Arc<RClient>,
		selendra_backend: Arc<RBackend>,
	) -> Self {
		Self {
			...
			relay_chain_backend: selendra_backend,
			relay_chain_client: selendra_client,
			_phantom: PhantomData,
		}
	}
