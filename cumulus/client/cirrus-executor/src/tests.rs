...
use sp_core::Pair;
use kp_executor::{ExecutionPhase, ExecutorPair, FraudProof, SignedExecutionReceipt};
...
async fn fraud_proof_verification_in_tx_pool_should_work() {
    ...
    let tx = kumandra_test_runtime::UncheckedExtrinsic::new_unsigned(
    ...
    match submit_invalid_fraud_proof_result.unwrap_err() {
        sc_transaction_pool::error::Error::Pool(
            ...
            invalid_tx,
            kp_executor::InvalidTransactionCode::FraudProof.into()
        ),
...
async fn pallet_executor_unsigned_extrinsics_should_work() {
        ...
        .unwrap_err()
    {
        sc_transaction_pool::error::Error::Pool(
            ...
            invalid_tx,
            kp_executor::InvalidTransactionCode::ExecutionReceipt.into()
        ),
