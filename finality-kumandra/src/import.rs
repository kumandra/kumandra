    ...
    I: crate::ClientForKumandra<Block, Be>,
{
    ...
    fn send_justification(
        ...
        let kumandra_justification = backwards_compatible_decode(justification_raw)?;
        ...
        self.send_justification(hash, number, justification)
            .map_err(|error| match error {
                ...
                SendJustificationError::Decode(e) => {
                    warn!(target: "kumandra-justification", "Justification for block {:?} decoded incorrectly: {}", number, e);
