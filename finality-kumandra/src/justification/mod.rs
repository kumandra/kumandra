...
pub use compatibility::{backwards_compatible_decode, KumandraJustificationV1, JustificationDecoding};
...
pub struct KumandraJustification {
...
pub struct JustificationNotification<Block: BlockT> {
    ...
    pub justification: KumandraJustification,
